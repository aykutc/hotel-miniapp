    ...
    <div className={styles.container}>
      ...
      <div className={styles.detailContainer}>
            ...
            <div className={styles.roomContainer}>
              <div className={styles.dateWrapper}>
                ...
                <div className={styles.roomTextWrapper}>
                  <p className={styles.roomTitle}>{hotelDetail.booking.calander.date}</p>
                  <p className={styles.roomSubTitle}>{hotelDetail.booking.calander.time} Nights</p>
                </div>
              </div>
              ...
              <div className={styles.roomWrapper}>
                <Bed />
                <div className={styles.roomTextWrapper}>
                  <p className={styles.roomTitle}>{hotelDetail.booking.room.count} Room</p>
                  <p className={styles.roomSubTitle}>{hotelDetail.booking.room.adult} Adult</p>
                </div>
              </div>
            </div>
            {/* Room Start  */}
        ...
        <div className={styles.aboutContainer}>
          ...
          <p className={styles.aboutText}>TROJENA will redefine mountain tourism for the world by creating a place based on the principles of ecotourism, highlighting our efforts to preserve nature and enhance the ....</p>
        ...
        <div className={styles.recommendedContainer}>
          {RecommendedArray.map((item) => {
            return <RecommendedCard key={item.title} title={item.title} subTitle={item.subTitle} block={item.block} img={item.img} imgWebp={item.imgWebp} price={item.price} discountPrice={item.discountPrice} imageStyles={{ width: '100%', height: 118, display: 'block' }}></RecommendedCard>;
          })}
        </div>
        {/* Recommend End  */}
      </div>
