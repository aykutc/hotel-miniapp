...
function HotelDetail({ f7router }) {
  ...
  return (
    <Page>
      <div style={{ overflow: "hidden", overscrollBehavior: "none" }}>
        <div
          className={"container"}
          style={{
            display: "flex",
            ...
            <div>
              ...
              >
                ...
                <div className={"aboutContainer"}>
                  ...
                  >
                    TROJENA will redefine mountain tourism for the world by
                    creating a place based on the principles of ecotourism,
                    highlighting our efforts to preserve nature and enhance the
                    ....
                  </p>
                  <span
                    className={"readMore"}
